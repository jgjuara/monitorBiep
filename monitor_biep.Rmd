...
BIEP_EDUCA <- fread("curl https://www.argentina.gob.ar/sites/default/files/biep_puestos_de_trabajo_-_apn_s_nivel_educ_11.zip | funzip",
                    dec = ",")
...
ipc <- ipc %>% 
  mutate(Período =
           case_when(
             ...
             indice_tiempo == "2020-07-01" ~ 202007,
           ))
